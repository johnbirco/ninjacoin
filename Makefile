#############################################################################
# Makefile for building: ninjacoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: mar. juin 17 12:55:32 2014
# Project:  ninjacoin-qt.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile ninjacoin-qt.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++-64 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork -I/usr/include/qt4/QtGui -I/usr/include/qt4 -Isrc -Isrc/json -Isrc/qt -IC:/deps -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -LC:/deps/miniupnpc -lminiupnpc /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libleveldb.a /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libleveldb.a /home/leo/Coinapp/wall/ninjacoinexplorer/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_poolbrowser.h build/ui_statisticspage.h build/ui_blockbrowser.h build/ui_optionsdialog.h build/ui_chatwindow.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: ninjacoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile ninjacoin-qt.pro
...
dist: 
	@$(CHK_DIR_EXISTS) build/ninjacoin-qt1.2.2 || $(MKDIR) build/ninjacoin-qt1.2.2 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/coincontroldialog.h src/qt/coincontroltreewidget.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/coincontrol.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt.h src/pbkdf2.h src/zerocoin/Accumulator.h src/zerocoin/AccumulatorProofOfKnowledge.h src/zerocoin/Coin.h src/zerocoin/CoinSpend.h src/zerocoin/Commitment.h src/zerocoin/ParamGeneration.h src/zerocoin/Params.h src/zerocoin/SerialNumberSignatureOfKnowledge.h src/zerocoin/SpendMetaData.h src/zerocoin/ZeroTest.h src/zerocoin/Zerocoin.h src/serialize.h src/strlcpy.h src/main.h src/miner.h src/net.h src/key.h src/db.h src/txdb.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/statisticspage.h src/qt/poolbrowser.h src/qt/blockbrowser.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/bloom.h src/checkqueue.h src/hash.h src/hashblock.h src/limitedmap.h src/sph_blake.h src/sph_bmw.h src/sph_cubehash.h src/sph_echo.h src/sph_groestl.h src/sph_jh.h src/sph_keccak.h src/sph_luffa.h src/sph_shavite.h src/sph_simd.h src/sph_skein.h src/sph_types.h src/threadsafety.h src/qt/chatwindow.h src/qt/serveur.h src/txdb-leveldb.h src/qt/qcustomplot.h build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/txdb-leveldb.cpp src/bloom.cpp src/hash.cpp src/blake.c src/bmw.c src/cubehash.c src/echo.c src/groestl.c src/jh.c src/keccak.c src/luffa.c src/shavite.c src/simd.c src/skein.c src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/coincontroldialog.cpp src/qt/coincontroltreewidget.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/qt/chatwindow.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/miner.cpp src/qt/statisticspage.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/blockbrowser.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/qt/qcustomplot.cpp src/qt/poolbrowser.cpp src/qt/serveur.cpp src/noui.cpp src/kernel.cpp src/scrypt-arm.S src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt.cpp src/pbkdf2.cpp src/zerocoin/Accumulator.cpp src/zerocoin/AccumulatorProofOfKnowledge.cpp src/zerocoin/Coin.cpp src/zerocoin/CoinSpend.cpp src/zerocoin/Commitment.cpp src/zerocoin/ParamGeneration.cpp src/zerocoin/Params.cpp src/zerocoin/SerialNumberSignatureOfKnowledge.cpp src/zerocoin/SpendMetaData.cpp src/zerocoin/ZeroTest.cpp build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/qt/forms/coincontroldialog.ui src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/poolbrowser.ui src/qt/forms/statisticspage.ui src/qt/forms/blockbrowser.ui src/qt/forms/optionsdialog.ui src/qt/forms/chatwindow.ui build/ninjacoin-qt1.2.2/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts build/ninjacoin-qt1.2.2/ && (cd `dirname build/ninjacoin-qt1.2.2` && $(TAR) ninjacoin-qt1.2.2.tar ninjacoin-qt1.2.2 && $(COMPRESS) ninjacoin-qt1.2.2.tar) && $(MOVE) `dirname build/ninjacoin-qt1.2.2`/ninjacoin-qt1.2.2.tar.gz . && $(DEL_FILE) -r build/ninjacoin-qt1.2.2


clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libleveldb.a; cd /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libleveldb.a: FORCE
	cd /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/home/leo/Coinapp/wall/ninjacoinexplorer/build/build.h: FORCE
	cd /home/leo/Coinapp/wall/ninjacoinexplorer; /bin/sh share/genbuild.sh /home/leo/Coinapp/wall/ninjacoinexplorer/build/build.h
...
build/moc_poolbrowser.cpp: src/qt/clientmodel.h \
		src/main.h \
		src/bignum.h \
		src/serialize.h \
		src/allocators.h \
	...
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) src/qt/poolbrowser.h -o build/moc_poolbrowser.cpp
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/mini.png \
		src/qt/res/icons/clock5.png \
		src/qt/res/icons/qrcode.png \
		src/qt/res/icons/ninjacoin-16.png \
		src/qt/res/icons/ninjacoin-80.png \
		src/qt/res/icons/remove.png \
		src/qt/res/icons/tx_inout.png \
		src/qt/res/icons/key.png \
		src/qt/res/icons/ninjacoin-16.png \
		src/qt/res/icons/irc.png \
		...
		src/qt/res/icons/balance.png \
		src/qt/res/icons/recent.png \
		src/qt/res/icons/detail.png
...
build/ui_poolbrowser.h: src/qt/forms/poolbrowser.ui \
		src/qt/qcustomplot.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/uic src/qt/forms/poolbrowser.ui -o build/ui_poolbrowser.h
...
build/poolbrowser.o: src/qt/poolbrowser.cpp src/qt/poolbrowser.h \
		src/qt/clientmodel.h \
		src/main.h \
		src/bignum.h \
		src/serialize.h \
		...
		src/json/json_spirit_utils.h \
		src/checkpoints.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/poolbrowser.o src/qt/poolbrowser.cpp
...
build/moc_poolbrowser.o: build/moc_poolbrowser.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/moc_poolbrowser.o build/moc_poolbrowser.cpp
