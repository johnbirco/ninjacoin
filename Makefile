...
# Generated by qmake (2.01a) (Qt 4.8.6) on: lun. juin 16 17:26:03 2014
...
CXXFLAGS      = -fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2 -fdiagnostics-show-option -Wall -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector -D_REENTRANT $(DEFINES)
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libleveldb.a /home/leo/Coinapp/wall/ninjacoinexplorer/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lQtGui -lQtNetwork -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
