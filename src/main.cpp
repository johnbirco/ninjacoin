...
const string strMessageMagic = "ninjacoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ninjacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "This is ninjacoin";
        CTransaction txNew;
        txNew.nTime = 1401906013;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1401906013;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4693555;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7a7abaf40c307028658e21e499f8f6cfe1ad0b5a9b3eb963cd824a6904a2ccc9"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xe1, 0xc2, 0xe4, 0xf6 };
