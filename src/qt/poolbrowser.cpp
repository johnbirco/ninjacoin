...
const QString kBaseUrl3 = "http://bittrex.com/api/v1/public/getorderbook?market=BTC-NJA&type=both&depth=50";
const QString kBaseUrl4 = "http://poloniex.com/public?command=returnTicker";
const QString kBaseUrl5 = "http://www.poloniex.com/public?command=returnOrderBook&currencyPair=BTC_NJA";
const QString kBaseUrl6 = "http://bittrex.com/api/v1/public/getmarkethistory?market=BTC-NJA&count=100";
...
{
    QDesktopServices::openUrl(QUrl("https://www.bittrex.com/Market/Index?MarketName=BTC-NJA"));
}

void PoolBrowser::poloniex()
{
    QDesktopServices::openUrl(QUrl("https://poloniex.com/exchange/btc_nja"));
}
...
if (what == kBaseUrl)
{
    ...
    QStringList data2 = data.split("{\"MarketName\":\"BTC-NJA\",\"High\":");
...
//    QStringList data2 = data.split("\"BTC-NJA\":{\"last\":\"");
