    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("ninjacoin") + " - " + tr("Wallet"));
    qApp->setStyleSheet("QMainWindow { background:rgb(255,255,255);font-family:'Proxima Nova Rg'; } #toolbar2 { border:none;width:28px; background:rgb(98, 175, 183); }");
#ifndef Q_OS_MAC
    ...
    //setObjectName("ninjaWallet");
    //setStyleSheet("#ninjaWallet { background:rgb(255,255,255) } QToolTip { color: #ffffff; background-color: #000000;  border:0px;} ");
...
//    connect(chatAction, SIGNAL(triggered()), this, SLOT(gotoChatPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About ninjacoin"), this);
    aboutAction->setToolTip(tr("Show information about ninjacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for ninjacoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("ninjacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("ninjacoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ninjacoin network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ninjacoin address or malformed URI parameters."));
    }
